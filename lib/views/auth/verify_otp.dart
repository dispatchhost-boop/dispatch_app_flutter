...
class _VerifyOtpScreenState extends State<VerifyOtpScreen> {
              ...
              Scaffold(
                ...
                appBar: AppBar(
                  ...
                  title: MyTextStyles.getSemiBoldText(
                    text: AppStrings.verifyingNumber,
                    size: 20,
                  ),
                ),
                  ...
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyTextStyles.getRegularText(text: AppStrings.weHaveSentYourVerificationCode, size: 16),
                        const SizedBox(height: 40,),
                        _buildTextField(),
                        const SizedBox(height: 25),
                        _buildVerifyButton(loader),
  ...
  Widget _buildTextField(){
    return CommonWidget.buildTextField(controller: _mobileController, hint: AppStrings.enterCode);
  }

  Widget _buildVerifyButton(WidgetRef ref) {
